...
curl -fsSL -H 'Cache-Control: no-cache' https://raw.githubusercontent.com/axetroy/fslint/master/install.sh | bash -s v0.3.0
# or install from gobinaries.com
curl -sf https://gobinaries.com/axetroy/fslint@v0.3.0 | sh
```
